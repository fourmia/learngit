...
from Product.Dataprocess import Znwg
import pandas as pd
...
# 写入NC文件必要信息
now = dt.datetime.now()
filetime = Znwg.znwgtime().strftime('%Y%m%d%H%M%S')
fh = range(3, 169, 3)
fnames = ['_%03d' % i for i in fh]


# 配置文件路径及道路文件路径
windpath = r'/home/cqkj/LZD/Product/Product/Source/Road_wind.csv'
roadpath = r'/home/cqkj/LZD/Product/Product/Source/QHroad_update.csv'
trafficpath = r'/home/cqkj/LZD/Product/Product/config/Traffic.xml'
forestpath = r'/home/cqkj/LZD/Product/Product/config/forest.xml'